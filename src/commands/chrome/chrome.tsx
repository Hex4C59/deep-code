...
function ClaudeInChromeMenu(t0) {
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t10 = <Text dimColor={true}>Learn more: https://github.com/aimsl/close-code</Text>;
    $[33] = t10;
  } else {
    t10 = $[33];
  }

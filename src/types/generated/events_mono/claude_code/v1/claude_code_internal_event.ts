...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      remote_environment_type: isSet(object.remote_environment_type)
        ...
        : '',
      claude_code_container_id: isSet(object.close_code_container_id)
        ? globalThis.String(object.close_code_container_id)
        : '',
      claude_code_remote_session_id: isSet(object.close_code_remote_session_id)
        ? globalThis.String(object.close_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.close_code_container_id !== undefined) {
      obj.close_code_container_id = message.close_code_container_id
    }
    if (message.close_code_remote_session_id !== undefined) {
      obj.close_code_remote_session_id = message.close_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.close_code_container_id = object.close_code_container_id ?? ''
    message.close_code_remote_session_id =
      object.close_code_remote_session_id ?? ''

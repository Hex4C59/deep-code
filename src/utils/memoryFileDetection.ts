...
/**
 * Detects if a file path is a session-related file under ~/.close.
 ...
 * Excludes: AGENTS.md, AGENTS.local.md, .close/rules/*.md (user-managed).
 *
...
// Excludes AGENTS.md, AGENTS.local.md, .close/rules/ (user-managed).

...
export function getUserAgent(): string {
  ...
  return `claude-cli/${'0.0.1'} (${process.env.USER_TYPE}, ${process.env.CLAUDE_CODE_ENTRYPOINT ?? 'cli'}${agentSdkVersion}${clientApp}${workloadSuffix})`
}
...
export function getMCPUserAgent(): string {
  ...
  return `claude-code/${'0.0.1'}${suffix}`
}

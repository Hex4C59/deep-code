  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.close/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .close/settings.json'
      } else {
        userGuidance =
      ...
      // from .close/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }

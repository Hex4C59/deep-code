...
/**
 * Check if a model ID is a foundation model (e.g., "anthropic.legacy-sonnet-4-5-20250929-v1:0")
 */
 ...
 * For example:
 * - "eu.anthropic.legacy-sonnet-4-5-20250929-v1:0" → "eu"
 * - "us.anthropic.claude-3-7-sonnet-20250219-v1:0" → "us"
 * - "arn:aws:bedrock:ap-northeast-2:123:inference-profile/global.anthropic.legacy-opus-4-6-v1" → "global"
 * - "anthropic.claude-3-5-sonnet-20241022-v2:0" → undefined (foundation model)
 * - "legacy-sonnet-4-5-20250929" → undefined (first-party format)
 */
 ...
 *
 * For example:
 * - applyBedrockRegionPrefix("us.anthropic.legacy-sonnet-4-5-v1:0", "eu") → "eu.anthropic.legacy-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("anthropic.legacy-sonnet-4-5-v1:0", "eu") → "eu.anthropic.legacy-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("legacy-sonnet-4-5-20250929", "eu") → "legacy-sonnet-4-5-20250929" (not a Bedrock model)
 */

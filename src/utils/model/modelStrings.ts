 ...
 * provider-derived model strings. Overrides are keyed by canonical model ID
 * and map to arbitrary provider-specific strings.
 */
 ...
 * unchanged. Safe to call during module init (no-ops if settings aren't loaded
 * yet).
 */

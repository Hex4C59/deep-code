// Non-React scheduler core for .close/scheduled_tasks.json.
...
type CronSchedulerOptions = {
  ...
  /**
   * Directory containing .close/scheduled_tasks.json. When provided, the
...
export function buildMissedTaskNotification(missed: CronTask[]): string {
  ...
  const header =
    ...
    `${plural ? 'They have' : 'It has'} already been removed from .close/scheduled_tasks.json.\n\n` +

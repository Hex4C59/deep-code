...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.close/skills)
  ...
  // User commands directory (~/.close/commands)
  ...
  // Project skills directory (.close/skills)
  ...
  // Project commands directory (.close/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.close', 'skills')
    try {

...
export const DESCRIPTION = 'Get or set Close Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Close Code configuration settings.

  View or change Close Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.close.json)
${globalSettings.join('\n')}

...
import { getEditorDisplayName, getExternalEditor } from '../../utils/editor.js';
    ...
    t9 = () => {
      if (shouldShowExternalEditorHint && editor) {
        ...
        addNotification({
          ...
          jsx: <Text dimColor={true}><ConfigurableShortcutHint action="chat:externalEditor" context="Chat" fallback="ctrl+g" description={`edit in ${getEditorDisplayName(editor)}`} /></Text>,
          priority: "immediate",
          timeoutMs: 5000
        });
      } else {

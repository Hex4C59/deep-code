...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.close/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.close/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.close/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.close/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.close/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.close/agent-memory-local/)",
      value: "local"

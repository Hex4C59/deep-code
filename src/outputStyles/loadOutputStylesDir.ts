...
/**
 * Loads markdown files from .close/output-styles directories throughout the project
 * and from ~/.close/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .close/output-styles/*.md -> project styles
 * - User ~/.close/output-styles/*.md -> user styles (overridden by project styles)
 *
